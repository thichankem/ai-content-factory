...
name: create-project
description: >-
  Create a new production project in the AI Content Factory via the HTTP
  API. Use when the user wants to add a project/topic/idea, or to set up a
  project before generating a script.
---
...
1. Ask the user (or take from context) three values:
   - name (max 120 chars, e.g. "The quiet power of small habits")
   - topic (max 500 chars — the story angle/source to explore)
...
4. Report the project id to the user. Next step is usually the
