...
name: lint
description: >-
  Lint and type-check the codebase with ruff (check + format) and mypy, using
  the same gates as GitHub Actions. Use after editing Python code or when the
  user asks to lint / format / typecheck / quality-gate the repo.
---
...
3. Fix every issue until the script exits 0:
   - ruff `E/F/I/UP/B` rule violations → fix the code or imports.
