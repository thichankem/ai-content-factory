...
export function ScriptBriefSettingsPanel({
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const newAdded: Array<{ id: string; name: string; size: number; type: string }> = [];
  ...
  return (
    <div className="flex flex-col h-full min-h-0 overflow-y-auto px-2 py-1 pr-3 scrollbar-thin scrollbar-thumb-nle-border">
      {/* Container 1 CỘT DUY NHẤT: Thoáng đãng, căn giữa, dễ nhìn */}
      <div className="flex flex-col space-y-4 max-w-4xl mx-auto w-full pb-8">
        ...
        {/* ========================================================================= */}
        {/* 8. DỮ LIỆU CỤ THỂ - NHIỀU FILE & NHIỀU TRANG WEB (TRÁNH AI BỊA ĐẶT) */}
        {/* ========================================================================= */}
        <Card className="border-nle-border bg-nle-surface/90 shadow-md">
          <CardHeader className="py-3 px-4 border-b border-nle-border flex flex-row items-center justify-between">
            <CardTitle className="text-sm font-bold text-white flex items-center">
          ...
          <CardContent className="p-4 space-y-4">
            ...
            {/* 8.2 Multiple File Attachments Bin */}
            <div className="p-3 rounded-lg bg-nle-panel border border-nle-border space-y-2.5">
        ...
        {/* ========================================================================= */}
        {/* 10. ĐIỀU CẦN TRÁNH (NEGATIVE CONSTRAINTS) */}
        {/* ========================================================================= */}
        <Card className="border-nle-border bg-nle-surface/90 shadow-md">
          <CardHeader className="py-3 px-4 border-b border-nle-border flex flex-row items-center justify-between">
            <CardTitle className="text-sm font-bold text-white flex items-center">
        ...
        {/* BOTTOM ACTION BAR */}
        {/* ========================================================================= */}
        <div className="sticky bottom-0 z-20 bg-nle-panel/95 backdrop-blur border border-nle-border rounded-xl p-3.5 flex items-center justify-between shadow-2xl">
          <div className="flex items-center space-x-2">
            <Button
              variant="outline"
              size="sm"
